...
$sql = "SELECT CONCAT(f.f_name, ' ', f.m_name, ' ', f.l_name) AS name, e.log_date, e.time_enter, e.time_leave
...
echo "<p>The following Faculty were in $san_building at $san_time:</p>";
...
if (mysqli_num_rows($result) > 0) {
    ...
    echo "No faculty were in $san_building at $san_time.";
}
